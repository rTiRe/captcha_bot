...
APPROVE_ERROR_MESSAGE = '❌ *Ошибка* обработки запроса. Попробуйте еще раз.'
...
EDIT_TIMEOUT_MESSAGE_BUTTON = '⌛ Сообщение таймаута'
...
NEW_TIMEOUT_MESSAGE_MESSAGE = 'Отправьте новое сообщение для пользователей, не прошедших капчу (оставьте пустым, чтобы не отображать):'
